...
$securePassword = Read-Host -Prompt "Введіть пароль AnyDesk" -AsSecureString
$password = [Runtime.InteropServices.Marshal]::PtrToStringAuto(
    [Runtime.InteropServices.Marshal]::SecureStringToBSTR($securePassword)
)

cmd /c "echo $password | `"$anydesk`" --set-password"
Write-Host "  [OK] Пароль AnyDesk встановлено" -ForegroundColor Green
